            ...
            if participant.treatment:
                player.participant.question_list = {
                    ...
                    'A3Q1a': [[(5, 2), (5, 3), (90, "Stage 2")], [(10, 2), (90, "Stage 2")],
                              'no third option',
                              [(50, 8), (50, 9)], [(50, 8), (50, 9)]],
                    'A3Q1b': [[(10, 2), (90, "Stage 2")], [(10, 2), (10, 7), (80, "Stage 2")],
                              'no third option',
                              [(50, 8), (50, 9)], [(50, 8), (50, 9)]],
                    'A3Q1c': [[(5, 2), (5, 3), (90, "Stage 2")], [(10, 2), (10, 7), (80, "Stage 2")],
                              'no third option',
                              [(50, 8), (50, 9)], [(50, 8), (50, 9)]],
                    'A3Q2a': [[(6, 3), (9, 2), (85, "Stage 2")], [(7, 3), (8, 2), (85, "Stage 2")],
                              'no third option',
                              [(50, 8), (50, 7)], [(50, 8), (50, 7)]],
                    'A3Q2c': [[(6, 3), (9, 2), (85, "Stage 2")], [(2, 12), (18, 1), (80, "Stage 2")],
                              'no third option',
                              [(50, 8), (50, 7)], [(50, 8), (50, 7)]],
                    'A3Q2b': [[(7, 3), (8, 2), (85, "Stage 2")], [(2, 12), (18, 1), (80, "Stage 2")],
                              'no third option',
                              [(50, 8), (50, 7)], [(50, 8), (50, 7)]],
                    'A3Q3b': [[(10, 1), (0, 12), (90, "Stage 2")], [(7, 5), (8, 6), (85, "Stage 2")],
                              'no third option',
                              [(50, 6), (50, 7)], [(50, 6), (50, 7)]],
                    'A3Q3a': [[(12, 1), (3, 10), (85, "Stage 2")], [(0, 12), (10, 1), (90, "Stage 2")],
                              'no third option',
                              [(50, 6), (50, 7)], [(50, 6), (50, 7)]],
                    'A3Q3c': [[(12, 1), (3, 10), (85, "Stage 2")], [(7, 5), (8, 6), (85, "Stage 2")],
                              'no third option',
                              [(50, 6), (50, 7)], [(50, 6), (50, 7)]],
                    'A3Q4c': [[(5, 12), (5, 0), (90, "Stage 2")], [(6, 2), (4, 4), (90, "Stage 2")],
                              'no third option',
                              [(50, 7), (50, 8)], [(50, 7), (50, 8)]],
                    'A3Q4b': [[(14, 0), (1, 12), (85, "Stage 2")], [(6, 2), (4, 4), (90, "Stage 2")],
                              'no third option',
                              [(50, 7), (50, 8)], [(50, 7), (50, 8)]],
                    'A3Q4a': [[(5, 12), (5, 0), (90, "Stage 2")], [(14, 0), (1, 12), (85, "Stage 2")],
                              'no third option',
                              [(50, 7), (50, 8)], [(50, 7), (50, 8)]],
                    'A3Q5c': [[(5, 3), (0, 3), (95, "Stage 2")], [(8, 4), (12, 4), (80, "Stage 2")],
                              'no third option',
                              [(50, 9), (50, 8)], [(50, 9), (50, 8)]],
                    'A3Q5b': [[(8, 2), (12, 3), (80, "Stage 2")], [(8, 4), (12, 4), (80, "Stage 2")],
                              'no third option',
                              [(50, 9), (50, 8)], [(50, 9), (50, 8)]],
                    'A3Q5a': [[(5, 3), (0, 3), (95, "Stage 2")], [(8, 2), (12, 3), (80, "Stage 2")],
                              'no third option',
                              [(50, 9), (50, 8)], [(50, 9), (50, 8)]],
                }
            else:
                player.participant.question_list = {
                    ...
                    'A3Q1b': [[(90, 7.5), (5, 2), (5, 3)], [(90, 7.5), (10, 2)], 'no third option'],
                    'A3Q1c': [[(80, 7.5), (10, 7), (10, 2)], [(90, 7.5), (10, 2)], 'no third option'],
                    'A3Q1a': [[(80, 7.5), (10, 7), (10, 2)], [(90, 7.5), (5, 2), (5, 3)], 'no third option'],
                    'A3Q2a': [[(85, 7.5), (6, 3), (9, 2)], [(85, 7.5), (7, 3), (8, 2)], 'no third option'],
                    'A3Q2c': [[(85, 7.5), (6, 3), (9, 2)], [(80, 7.5), (2, 12), (18, 1)], 'no third option'],
                    'A3Q2b': [[(85, 7.5), (7, 3), (8, 2)], [(80, 7.5), (2, 12), (18, 1)], 'no third option'],
                    'A3Q3b': [[(90, 6.5), (0, 12), (10, 1)], [(85, 6.5), (7, 5), (8, 6)], 'no third option'],
                    'A3Q3a': [[(85, 6.5), (12, 1), (3, 10)], [(90, 6.5), (0, 12), (10, 1)], 'no third option'],
                    'A3Q3c': [[(85, 6.5), (12, 1), (3, 10)], [(85, 6.5), (7, 5), (8, 6)], 'no third option'],
                    'A3Q4c': [[(90, 7.5), (5, 12), (5, 0)], [(90, 7.5), (6, 2), (4, 4)], 'no third option'],
                    'A3Q4b': [[(85, 7.5), (14, 0), (1, 12)], [(90, 7.5), (6, 2), (4, 4)], 'no third option'],
                    'A3Q4a': [[(90, 7.5), (5, 12), (5, 0)], [(85, 7.5), (14, 0), (1, 12)], 'no third option'],
                    'A3Q5a': [[(90, 8.5), (3, 9), (7, 5)], [(90, 8.5), (0, 12), (10, 4)], 'no third option'],
                    'A3Q5b': [[(90, 8.5), (0, 12), (10, 4)], [(90, 8.5), (9, 0), (1, 3)], 'no third option'],
                    'A3Q5c': [[(90, 8.5), (3, 9), (7, 5)], [(90, 8.5), (9, 0), (1, 3)],  'no third option'],
