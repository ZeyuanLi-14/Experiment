...
class Results(Page):
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        transitivity_blist = ['A3Q1b', 'A3Q2b', 'A3Q3b', 'A3Q4b', 'A3Q4b']
        transitivity_clist = ['A3Q1c', 'A3Q2c', 'A3Q3c', 'A3Q4c', 'A3Q4c']
